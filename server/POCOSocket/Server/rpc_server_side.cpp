...
//CONSTANTS:
string DATABASE_CSV_FILE = "../Server/database.csv";
int SERVER_HOST_PORT = 3333;

//FILE FORMATS:

//Ingredients: vector<string>>                      Note: expiry date stored as 22.10.2024 format. NO slashes :))
...
int main() {
    rpc::server srv(SERVER_HOST_PORT);
